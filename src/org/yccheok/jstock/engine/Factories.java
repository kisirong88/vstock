...
public enum Factories {
    ...
    static {
        ...
        final List<StockServerFactory> vietnamList = new CopyOnWriteArrayList<StockServerFactory>();
        ...
        vietnamList.add(VietStockServerFactory.newInstance());
        ...
        map.put(Country.Vietnam, vietnamList);
    }
}
