 ...
 * @author yccheok
 */
public class VietMarketServer implements MarketServer {
    ...
    public java.util.List<Market> getMarkets(java.util.List<Index> indices) {
        ...
        StockServer stockServer = VietMarketServer.this.getStockServer();
        
        List<Code> codes = new ArrayList<Code>();
        for (Index index : indices) {
            //System.out.println("DEBUG Code: "+index.code.toString());
        ...
        for (Stock stock : stocks) {
            //System.out.println("DEBUG Stock: "+stock.getName()+" has code: "+stock.code.toString());
        ...
        for (Index index : indices) {
            ...
            if (stock != null) {
                //System.out.println("DEBUG Stock2: "+stock.getName()+" has code: "+stock.code.toString());
    ...
    private static final Log log = LogFactory.getLog(VietMarketServer.class);
}
